...
class SparkConnector:
    ...
    def handle_comm_message(self, msg):
        ...
        if action == "sparkconn-action-auth":
            ...
            try:
                ...
                conf = self.spark_configuration.configure(msg["content"]["data"], ports)
                ...
                self.send_error(
                    "sparkconn-connect-error",
                    "You reached the maximum number of parallel Spark connections. "
    ...
    def register_comm(self):
        ...
        self.ipython.kernel.comm_manager.register_target("SparkConnector", self.target_func)
    ...
    def create_properties_file(self, log_path):
        ...
        f.write("appender.file.fileName=%s\n" % log_path)
