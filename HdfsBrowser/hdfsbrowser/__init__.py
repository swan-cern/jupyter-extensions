...
def _jupyter_nbextension_paths():
    ...
    return [dict(section="notebook", src="nbextension", dest="hdfsbrowser", require="hdfsbrowser/extension")]


def _jupyter_labextension_paths():
    return [{"src": "labextension", "dest": "@swan-cern/hdfsbrowser"}]
...
def _load_jupyter_server_extension(server_app):
    ...
    hadoop_handlers = [(hdfs_browser_endpoint + ".*", HDFSBrowserProxy, dict(proxy_root=hdfs_browser_proxy_root))]
