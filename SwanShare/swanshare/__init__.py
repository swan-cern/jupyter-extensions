...
def _jupyter_nbextension_paths():
    ...
    return [
        dict(section="tree", src="nbextension", dest="swanshare", require="swanshare/extension"),
        dict(section="notebook", src="nbextension", dest="swanshare", require="swanshare/extension"),
    ]
